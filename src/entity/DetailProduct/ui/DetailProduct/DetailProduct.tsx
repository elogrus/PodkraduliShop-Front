...
export const DetailProduct = (props: DetailProductProps) => {
    ...
    else if (result.error) return <Text preset={TextPreset.SUBTITLE}>Произошла ошибка: {result.errorMessage}</Text>
    ...
    return (
        <div className={cmcl(cls.DetailProduct, {}, [className])} {...otherProps}>
            ...
            <div className={cls.Right}>
                <Text preset={TextPreset.TITLE} mods={[TextMods.BOLD]}>{product.title}</Text>
                <Price product={product} />
                <div className={cls.Description}>
                    <Text preset={TextPreset.SUBTITLE} mods={[TextMods.BOLD]}>Описание:</Text>
